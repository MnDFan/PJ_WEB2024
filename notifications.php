...
if ($db_found) {
    ...
    $sql = "SELECT * FROM notification WHERE IDacheteur='$user_id'";
    ...
    <div class="wrapper">
        ...
        <div class="content">
            <div class="form-container">
                <h1 class="form-title">Créer une alerte</h1>
                <form method="post" action="">
                    ...
                    <button type="submit" name="create_alert" >Créer l'alerte</button><br><br><br>
                </form>
                <h1 class="form-title">Alertes existantes</h1>
                <table>
                    <tr>
                    ...
                    if ($alerts_result && mysqli_num_rows($alerts_result) > 0) {
                        ...
                        echo "<tr><td colspan='5'>Aucune alerte enregistrée</td></tr>";
                    }
                    ?>
                </table><br><br>
                <h1 class="form-title">Produits correspondant à vos alertes</h1>
                <?php
                if ($alerts_result && mysqli_num_rows($alerts_result) > 0) {
